...
class StatsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SysStats = channel.unary_unary(
                '/xray.app.stats.command.StatsService/SysStats',
...
class StatsServiceServicer(object):
    ...
    def SysStats(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_StatsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SysStats': grpc.unary_unary_rpc_method_handler(
                    servicer.SysStats,
...
class StatsService(object):
    ...
    def SysStats(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xray.app.stats.command.StatsService/SysStats',
